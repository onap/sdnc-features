...
@WebMvcTest(PreTestController.class)
//@Transactional
//@DataJpaTest
//@AutoConfigureTestDatabase(replace=AutoConfigureTestDatabase.Replace.NONE)
public class PreTestControllerTest {
    ...
    public void whenFindReportByDeviceName_thenReturnThis()
      throws Exception {			
		 ...
		 startTimeVal=startDate.getTime();
        ...
        mvc.perform(get("/findReportByDeviceName/{startDate}/{endDate}/{deviceName}/",startTimeVal,endTimeVal,"Router")
